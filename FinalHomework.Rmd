...
```{r clustering_one_pca_plots, figures-side, fig.show="hold", out.width="50%"}
...
```{r clustering_one_non_pca_plots, figures-side, fig.show="hold", out.width="50%"}
...
The output dendrograms are really complicated, but it's obvious that best separation option is 2 clusters.
\n
\n
...
```{r classification_one_imbalanced}
train_control <- trainControl(method = "repeatedcv",number = 10,repeats = 3)
...
\n
```{r classification_two_imbalanced}
